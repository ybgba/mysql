...
MYSQLGROUP='mysql'
MYSQLUSER='mysql'
BASEDIR='/mnt/mysql5635'
DATADIR='/data/ane56'
MYSQLBINLOG='/data/mysqlbinlog'
CONF='/mnt/mysql5635/etc'
INIT='/mnt/mysql5635/init.d'
SOCKET='/data/ane56/mysqld.sock'
PORT='3306'
MYSQL='/usr/bin/mysql'
PACKAGE='percona-server-5.6.35-80.0.tar.gz'
SOURCEFOLDER='percona-server-5.6.35-80.0'
LIB='libev4-4.15-7.1.x86_64.rpm'
BACKFILE='percona-xtrabackup-24-2.4.6-2.el6.x86_64.rpm'
...
if [ ! -f $PACKAGE ]; then
	$WGET https://www.percona.com/downloads/Percona-Server-5.6/Percona-Server-5.6.35-80.0/source/tarball/percona-server-5.6.35-80.0.tar.gz
fi
...
## download if not exists
if [ ! -f $BACKFILE ]; then
        $WGET https://www.percona.com/downloads/XtraBackup/Percona-XtraBackup-2.4.6/binary/redhat/6/x86_64/percona-xtrabackup-24-2.4.6-2.el6.x86_64.rpm
fi
