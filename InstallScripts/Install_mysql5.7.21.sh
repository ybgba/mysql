...
MYSQL='/usr/bin/mysql'
PACKAGE='mysql-5.7.21-linux-glibc2.12-x86_64.tar.gz'
SOURCEFOLDER='mysql-5.7.21-linux-glibc2.12-x86_64'
...
if [ ! -f $STARTFILE ]; then
	...
	echo "numactl --interleave=all $BASEDIR/bin/mysqld_safe --defaults-file=$BASEDIR/$CONF/$CONFFILE &" >> $STARTFILE
fi
